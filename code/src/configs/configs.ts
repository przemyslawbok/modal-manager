...
export const pageConfig: CustomPageConfig = CustomPageConfigFactory([ContentType.Edit, ContentType.Developments, ContentType.Inspiration], contentsConfigs);
export const restrictedPageConfig: CustomPageConfig = CustomPageConfigFactory([ContentType.Developments, ContentType.Inspiration], contentsConfigs);